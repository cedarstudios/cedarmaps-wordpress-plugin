...
$markers = !empty($options['markers']) ? $options['markers'] : [];
...
<hr/>
<div>
    <form method="post" name="cedar_map_options" action="options.php">
        <?php
        ...
        <div class="form-group">
            ...
            <input type="Width" class="form-control" id="<?php echo $this->plugin_name ?>-width"
        ...
        <div class="form-group">
            ...
            <input type="height" class="form-control" id="<?php echo $this->plugin_name ?>-height"
        ...
        <div class="form-group">
            <label for="scroll_wheel_zoom">Scroll Wheel Zoom</label>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div data-plugin-name="<?php echo $this->plugin_name ?>" class="btn btn-primary form-marker-btn"> + Add
                    Marker
                </div>
            </div>
